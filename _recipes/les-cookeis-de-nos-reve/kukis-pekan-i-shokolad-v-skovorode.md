...
recipe:
  ...
  ingredients_markdown: '**Для карамелизированного пекана**
    ...
    * 45 г черного шоколада типа Guanaja de Valrhona
  ...
  directions_markdown: '1. Приготовьте карамелизированные орехи пекан. Разогрейте
    ...
    2. В сотейник всыпьте сахар и растопите его всухую до получения светло-золотистой
    карамели (не перемешивайте— под действием тепла сахар сам растает и карамелизуется).


    3. Добавьте орехи, перемешайте, чтобы их «засахарить» (то есть покрыть сахаром,
    который может сначала побелеть и закристаллизоваться, а затем снова расплавиться
    от жара).


    4. Когда орехи хорошо покроются карамелью, снимите их с огня, вмешайте масло и
    ...
    5. Приготовьте тесто для кукис. Смешайте размягчённое сливочное масло, сахар вержуаз
    ...
    6. Ввеедите яйцо и тщательно перемешайте до однородности. Добавьте просеянную
    муку, затем 50 г измельчённых орехов и шоколад.


    7. Сформируйте 4 шарика по 80 г, расплющите их в круги диаметром 10 см и выложите
    ...
    8. Разогрейте духовку до 200 °C. Запекайте кукис 12 минут. Сразу после выпекания
