...
recipe:
  ...
  directions_markdown: '1. Взбейте сливочное масло с сахаром вержуаз до кремообразной
    ...
    3. С помощью столовой ложки отмерьте порции теста по 45 г. Скатайте их в шарики (предварительно
    ...
    4. Важно прекратить выпечку, как только кукис станет золотисто- желтым. Помните,
    это печенье, а значит, оно должно быть недопеченным, иначе можно сломать зуб!


    5. Откройте вафельницу и дайте печенью остыть около 30 секунд (тесто начнёт немного
