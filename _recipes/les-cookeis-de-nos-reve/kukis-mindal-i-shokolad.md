...
recipe:
  ...
  directions_markdown: '1. Немного поломайте миндаль и грубо нарежьте шоколад.
    ...
    2. В миске вручную смешайте муку, сахар и миндальную муку. Добавьте яйцо и масло.
    Перемешайте. Когда тесто станет однородным, добавьте миндаль и шоколад.


    3. Сформируйте шарики по 50 г, затем положите их на противень, застеленный бумагой
    для выпечки, оставляя немного пространства между ними. Накройте пленкой и дайте
    отдохнуть 30 минут в холодильнике.


    4. Разогрейте духовку до 200 °C в статическом режиме. Выпекайте около 10 минут,
    пока печенье слегка не подрумянится и при этом останется мягким внутри.


    5. Дайте остыть на решетке после того, как достанете из духовки.


    СОВЕТ:  Для любителей горького миндаля - добавьте чайную ложку амаретто или
