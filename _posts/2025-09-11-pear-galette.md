        ...
        <div class="row masonry-container pt-5">
          {% for post in site.posts %}
            <div class="col-lg-3 col-sm-6 mb-5">
              <div class="card p-0 border-0 rounded-0 hover-shadow masonry-item">
                <img class="img-fluid rounded-top rounded-0" src="{{ post.featured_image | relative_url }}" alt="feature-image">
                <div class="card-body">
                  <ul class="list-inline mb-3">
                    {% for category in post.categories %}
                    <li class="list-inline-item mr-3 text-uppercase font-primary font-extra-small"><a href="{{ site.baseurl }}/categories/{{ category | downcase | slugify }}" class="text-color">{{ category }}</a></li>
                    {% endfor %}
                  </ul>
